...
PROTOBUF_NAMESPACE_OPEN
template<> ::infomation::Info* Arena::CreateMaybeMessage<::infomation::Info>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace infomation {
...
class Info :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:infomation.Info) */ {
 public:
  Info();
  virtual ~Info();
  ...
  // @@protoc_insertion_point(class_scope:infomation.Info)
 private:
  class HasBitSetters;
...
inline const std::string& Info::address() const {
  // @@protoc_insertion_point(field_get:infomation.Info.address)
...
inline void Info::set_address(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:infomation.Info.address)
}
inline void Info::set_address(std::string&& value) {
  
  address_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:infomation.Info.address)
}
inline void Info::set_address(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:infomation.Info.address)
}
inline void Info::set_address(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:infomation.Info.address)
}
inline std::string* Info::mutable_address() {
  
  // @@protoc_insertion_point(field_mutable:infomation.Info.address)
...
inline std::string* Info::release_address() {
  // @@protoc_insertion_point(field_release:infomation.Info.address)
...
inline void Info::set_allocated_address(std::string* address) {
  ...
  // @@protoc_insertion_point(field_set_allocated:infomation.Info.address)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Info::number() const {
  // @@protoc_insertion_point(field_get:infomation.Info.number)
  return number_;
}
inline void Info::set_number(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  number_ = value;
  // @@protoc_insertion_point(field_set:infomation.Info.number)
}
