...
static void InitDefaultsscc_info_Info_info_2eproto() {
  ...
  {
    void* ptr = &::infomation::_Info_default_instance_;
    new (ptr) ::infomation::Info();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::infomation::Info::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_info_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::infomation::Info, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::infomation::Info, address_),
  PROTOBUF_FIELD_OFFSET(::infomation::Info, number_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::infomation::Info)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::infomation::_Info_default_instance_),
};
...
Info::Info()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:infomation.Info)
}
Info::Info(const Info& from)
  ...
  // @@protoc_insertion_point(copy_constructor:infomation.Info)
}
...
Info::~Info() {
  // @@protoc_insertion_point(destructor:infomation.Info)
  SharedDtor();
}
...
void Info::Clear() {
// @@protoc_insertion_point(message_clear_start:infomation.Info)
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:infomation.Info)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:infomation.Info)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:infomation.Info)
  return false;
#undef DO_
}
...
void Info::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:infomation.Info)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:infomation.Info)
}

::PROTOBUF_NAMESPACE_ID::uint8* Info::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:infomation.Info)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:infomation.Info)
  return target;
}

size_t Info::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:infomation.Info)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:infomation.Info)
  GOOGLE_DCHECK_NE(&from, this);
  const Info* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Info>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:infomation.Info)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:infomation.Info)
    MergeFrom(*source);
  }
}

void Info::MergeFrom(const Info& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:infomation.Info)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:infomation.Info)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:infomation.Info)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::infomation::Info* Arena::CreateMaybeMessage< ::infomation::Info >(Arena* arena) {
  return Arena::CreateInternal< ::infomation::Info >(arena);
}
