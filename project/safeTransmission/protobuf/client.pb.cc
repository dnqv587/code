...
static void InitDefaultsscc_info_RequestMsg_client_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::client::_RequestMsg_default_instance_;
    new (ptr) ::client::RequestMsg();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::client::RequestMsg::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RequestMsg_client_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_RequestMsg_client_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_client_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::client::RequestMsg, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::client::RequestMsg, cmdtype_),
  PROTOBUF_FIELD_OFFSET(::client::RequestMsg, clientid_),
  PROTOBUF_FIELD_OFFSET(::client::RequestMsg, serverid_),
  PROTOBUF_FIELD_OFFSET(::client::RequestMsg, sign_),
  PROTOBUF_FIELD_OFFSET(::client::RequestMsg, data_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::client::RequestMsg)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::client::_RequestMsg_default_instance_),
};

const char descriptor_table_protodef_client_2eproto[] =
  "\n\014client.proto\022\006client\"]\n\nRequestMsg\022\017\n\007"
  "cmdType\030\001 \001(\005\022\020\n\010clientId\030\002 \001(\014\022\020\n\010serve"
  "rId\030\003 \001(\014\022\014\n\004sign\030\004 \001(\014\022\014\n\004data\030\005 \001(\014b\006p"
  "roto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_client_2eproto_sccs[1] = {
  &scc_info_RequestMsg_client_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_client_2eproto = {
  &descriptor_table_client_2eproto_initialized, descriptor_table_protodef_client_2eproto, "client.proto", 125,
...
RequestMsg::RequestMsg()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:client.RequestMsg)
}
RequestMsg::RequestMsg(const RequestMsg& from)
  ...
  // @@protoc_insertion_point(copy_constructor:client.RequestMsg)
}

void RequestMsg::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RequestMsg_client_2eproto.base);
  clientid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  serverid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  sign_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  data_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
RequestMsg::~RequestMsg() {
  // @@protoc_insertion_point(destructor:client.RequestMsg)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:client.RequestMsg)
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:client.RequestMsg)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:client.RequestMsg)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:client.RequestMsg)
  return false;
#undef DO_
}
...
void RequestMsg::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:client.RequestMsg)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:client.RequestMsg)
}

::PROTOBUF_NAMESPACE_ID::uint8* RequestMsg::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:client.RequestMsg)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:client.RequestMsg)
  return target;
}

size_t RequestMsg::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:client.RequestMsg)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:client.RequestMsg)
  GOOGLE_DCHECK_NE(&from, this);
  const RequestMsg* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RequestMsg>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:client.RequestMsg)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:client.RequestMsg)
    MergeFrom(*source);
  }
}

void RequestMsg::MergeFrom(const RequestMsg& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:client.RequestMsg)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:client.RequestMsg)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:client.RequestMsg)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::client::RequestMsg* Arena::CreateMaybeMessage< ::client::RequestMsg >(Arena* arena) {
  return Arena::CreateInternal< ::client::RequestMsg >(arena);
}
